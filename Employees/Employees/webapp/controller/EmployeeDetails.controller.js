...
sap.ui.define([
    ...
    function onCreateIncidence() {
        ...
        odata.push({ index: index + 1, _ValidDate: false, EnabledSave: false });
    ...
    function updateIncidenceReason(oEvent) {
        ...
        if (contextObj._ValidDate && oEvent.getSource().getValue()) {
            contextObj.EnabledSave = true;
        } else {
            contextObj.EnabledSave = false;
        };
